...
<template>
  <div class="flex items-center">
      ...
      <div class="modal-box">
        ...
        <div class="flex flex-col gap-3">
          ...
          <label class="flex w-full max-w-xs">
            ...
            <input
              v-model.number="temporaryPrize.frequency"
              type="number"
              min="1"
    ...
    <div ref="prizeListContainerRef">
      <div v-if="temporaryPrize.isShow" class="h-20 w-72 mb-2" :class="currentPrize.id === temporaryPrize.id ? 'current-prize' : ''">
        <div 
          ...
          @click="prizeConfig.setCurrentPrize(temporaryPrize)"
        >
          <div
        ...
        <div v-if="prizeShow && !isMobile" class="flex items-center">
          <ul ref="prizeListRef" class="flex flex-col gap-1 p-2 rounded-xl bg-slate-500/50">
            ...
            >
              <div
                v-if="item.isShow"
                class="relative flex flex-row items-center justify-between w-64 h-20 shadow-xl card bg-base-100 cursor-pointer hover:bg-base-200 transition-colors"
                @click="prizeConfig.setCurrentPrize(item)"
              >
                <div
                  v-if="item.isUsed"
                  class="absolute z-50 w-full h-full bg-gray-800/70 item-mask rounded-xl"
